...
public class CosultaOrientacao implements ActionListener {
	...
	public CosultaOrientacao(JTextField textFieldSubarea, JTextArea textAreaCS, JTextField textFieldNOMEGP,
		...
		private Grupos buscaorientação(Grupos grupo) throws IOException {
