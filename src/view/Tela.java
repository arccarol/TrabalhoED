...
public class Tela extends JFrame {
	...
	public Tela() {
		...
		ConsultaCorntoller CG=new ConsultaCorntoller(textFieldCodgpCp, textAreaCG, textFieldNOMEGP, textFieldTEMAGP, textFieldAREA, textFieldSUBAREA, textFieldDATA, TextAreaNomeAlunosGP, textAreaRAGP);
		btnPesquisar.addActionListener(CG);
